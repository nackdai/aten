...
inline __device__ void evalHitResultSphere(
...
inline __device__ void evalHitResultTriangle(
	const Context* ctxt,
	const aten::ShapeParameter* param,
	const aten::ray& r,
	aten::hitrecord* rec,
...
inline __device__ void evalHitResult(
	const Context* ctxt,
	const aten::ShapeParameter* param,
	const aten::ray& r,
	aten::hitrecord* rec,
	const aten::Intersection* isect)
{
	...
	if (realShape->type == aten::ShapeType::Polygon) {
		...
		evalHitResultSphere(param, r, rec, isect);
	}
	else {
		// TODO
	}

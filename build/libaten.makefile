...
Debug_Libraries=-Wl,--no-as-needed -Wl,--start-group -lGL -lglfw -lglew -l$(NOINHERIT)  -Wl,--end-group
Release_Libraries=-Wl,--no-as-needed -Wl,--start-group -lGL -lglfw -lglew -l$(NOINHERIT)  -Wl,--end-group

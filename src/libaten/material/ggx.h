...
namespace aten
{
	...
	public:
		MicrofacetGGX(
			...
			: material(MaterialType::MicrofacetGGX, MaterialAttributeMicrofacet, albedo, ior, albedoMap, normalMap)
		{
		...
		MicrofacetGGX(Values& val)
			: material(MaterialType::MicrofacetGGX, MaterialAttributeMicrofacet, val)
		{
